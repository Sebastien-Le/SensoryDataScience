...
## Anglais :
```{r}
res.textual.en.V2 <- textual(barbesV2.en,num.text = 3, contingence.by = 1, sep.word = ";")
...
plot.CA(res.CA.en.V2)

```

## Vietnamien avec accents :
```{r}
res.textual.viet.V2 <- textual(barbesV2.viet.acc,num.text = 3, contingence.by = 1, sep.word = ";")
...
plot.CA(res.CA.viet.V2)
```

## Vietnamien sans accents :
```{r}
res.textual.viet.sans.accent.V2 <- textual(barbesV2.viet.sans.acc,num.text = 3, contingence.by = 1, sep.word = ";")
...
plot.CA(res.CA.viet.sans.accent.V2) 
```

## Comparaison

```{r}
res.CA.en.V2$col$coord
res.CA.viet.V2$col$coord
res.CA.viet.sans.accent.V2$col$coord
```
