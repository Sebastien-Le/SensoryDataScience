...
Let's say you observe a bunch of random variables ![formula](https://render.githubusercontent.com/render/math?math=X_i), ![formula](https://render.githubusercontent.com/render/math?math=\{ X_1, \dots, X_n \}). From the realizations ![formula](https://render.githubusercontent.com/render/math?math=\{ X_1, \dots, X_n \}), you usually want to estimate the mean ![formula](https://render.githubusercontent.com/render/math?math=\mu) of your variables, to get some insights on your population. To do so, you use an estimator of ![formula](https://render.githubusercontent.com/render/math?math=\mu), usually ![formula](https://render.githubusercontent.com/render/math?math=\bar{X}_n=\frac{1}{n}\sum X_i). From this estimator (which is by the way a random variable), you can get an estimation of ![formula](https://render.githubusercontent.com/render/math?math=\mu) by calculating ![formula](https://render.githubusercontent.com/render/math?math=\bar{X}_n=\frac{1}{n}\sum X_i). The standard deviation ![formula](https://render.githubusercontent.com/render/math?math=\sigma) can be estimated using the following expression: ![formula](https://render.githubusercontent.com/render/math?math=s = \sqrt{\frac{1}{n}\sum(x_i-\bar{x})^2}).
