...
- Minimum (![formula](https://render.githubusercontent.com/render/math?math=Q_0) or ![formula](https://render.githubusercontent.com/render/math?math=\text{0}^{th}) percentile): the lowest data point in the data set excluding any outliers
- Maximum (![formula](https://render.githubusercontent.com/render/math?math=Q_4) or ![formula](https://render.githubusercontent.com/render/math?math=\text{100}^{th}) percentile): the highest data point in the data set excluding any outliers
- Median (![formula](https://render.githubusercontent.com/render/math?math=Q_2) or ![formula](https://render.githubusercontent.com/render/math?math=\text{50}^{th}) percentile): the middle value in the data set
- First quartile (![formula](https://render.githubusercontent.com/render/math?math=Q_1) or ![formula](https://render.githubusercontent.com/render/math?math=\text{25}^{th}) percentile): also known as the lower quartile, it is the median of the lower half of the data set
- Third quartile (![formula](https://render.githubusercontent.com/render/math?math=Q_3) or ![formula](https://render.githubusercontent.com/render/math?math=\text{75}^{th}) percentile): also known as the upper quartile, it is the median of the upper half of the data set
...
![formula](https://render.githubusercontent.com/render/math?math=P[x_1 \leq X \leq x_2] = F_X(x_2) - F_X(x_1) = \int_{x_1}^{x_2} f_X(x)dx = 0.3,)

where ![formula](https://render.githubusercontent.com/render/math?math=F_X()) is the so-called **cumulative function**, and ![formula](https://render.githubusercontent.com/render/math?math=f_X()) the density function of ![formula](https://render.githubusercontent.com/render/math?math=X), a continuous random variable associated with a sensory attribute.
...
Let's say you observe a bunch of random variables ![formula](https://render.githubusercontent.com/render/math?math=X_i), ![formula](https://render.githubusercontent.com/render/math?math=\{ X_1, \dots, X_n \}). From the realizations  ![formula](https://render.githubusercontent.com/render/math?math=\{ x_1, \dots, x_n \}), you usually want to estimate the mean ![formula](https://render.githubusercontent.com/render/math?math=\mu) of your variables, to get some insights on your population. To do so, you use an estimator of ![formula](https://render.githubusercontent.com/render/math?math=\mu), usually ![formula](https://render.githubusercontent.com/render/math?math=\bar{X}_n=\frac{1}{n}\sum X_i). From this estimator (which is by the way a random variable), you can get an estimation of ![formula](https://render.githubusercontent.com/render/math?math=\mu) by calculating ![formula](https://render.githubusercontent.com/render/math?math=\bar{x}=\frac{1}{n}\sum x_i). The standard deviation ![formula](https://render.githubusercontent.com/render/math?math=\sigma) can be estimated using the following expression: ![formula](https://render.githubusercontent.com/render/math?math=s = \sqrt{\frac{1}{n}\sum(x_i-\bar{x})^2}).
