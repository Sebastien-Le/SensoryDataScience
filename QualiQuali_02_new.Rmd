...
legend("topright", inset=.02, title="Political Party", c("Extreme left", "Left","Greens",'Liberal', 'Right'), horiz=TRUE, cex=0.8, fill=c("brown","palevioletred2", "chartreuse4","gold1", "dodgerblue3"))
